...
export default class CancelPayment extends React.Component{
    ...
    paymentReceive = () => {
        alert("hd")
        this.props.history.push("/home/paymentReceive")
    }
     render()
    {
        return(
            <div className="CancelPayment">
               ...
               <div className="payment_method_container">
                   <p className="select_pay_text">Please Select a Payment Method</p>
                      ...
                      <div className="pay_now_container"><Button className="pay_now_button" onClick={this.paymentReceive}>Pay Now</Button></div>
