      ...
      <TableRow>
        ...
        <TableHead>
            <TableRow
              ...
              tabIndex={-1}
            >
<TableCell align="right" style={{width:10}}>Sno</TableCell>
...
<TableCell align="left" style={{width:10}}>VIP</TableCell>
...
export default class Availabilitydetails extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      order: '', orderBy: 'media_title', selected: [], page: 0, dense: false, rowsPerPage: 5, viewmodal: false, 
      doctordetails:
        [(
          <div>
           <TableRow
                              ...
                              tabIndex={-1}
                            >
          <TableCell component="th" id={""} scope="row" padding="none"  style={{width:"7vw"}}>
                                 <div className="Availability-sno-wrapper">  {"1"} </div>
                               </TableCell>
                               <TableCell align="right" style={{ width: "13vw" }}><div ><Select className="availability-clinic-toggledropdown" defaultValue="Morning" style={{ width: 110 }} onChange={handleChange}>
                               ...
                               <TableCell align="right" style={{ width: "8.7vw"}}><Input value="4"  style={{ width: 40 }}/></TableCell>
                               <TableCell align="right" style={{ width: "16vw" }}><Input value="10.00 AM"  style={{ width: 90 }}/></TableCell>
                               <TableCell align="right" style={{ width: "13vw" }} ><Input value="4.00 PM" style={{ width: 90 }} /></TableCell>
 
                               <TableCell align="right" className="Abi" style={{ width: "13vw" }}><Input value="4" style={{ width: 60 }} /><label className="slot-duration-unit_label">Min</label></TableCell>
                               <TableCell align="right" style={{ width: "8vw" }}><div className="no_of_slots_data">8</div></TableCell>
  ...
  render() {
    const isSelected = name => this.state.selected.indexOf(name) !== -1;
      ...
      //  store.push(...this.state.doctordetails,
      //   <div></div>
