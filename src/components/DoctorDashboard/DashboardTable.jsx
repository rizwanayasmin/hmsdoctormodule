...
class DashboardTable extends React.Component{
    ...
    render(){
        ...
        return( 
         ...
         <Card  component={NavLink} to="/Home/appointments" className="nurse_button5 nurse_button_common_styles">
          ...
          <Card className="nurse_button1 nurse_button_common_styles" component={NavLink} to="/Home/doctorservice">
        ...
        <Card className="nurse_button3 nurse_button_common_styles" component={NavLink} to="/Home/cancelhistory">
          ...
          <Card className="nurse_button2 nurse_button_common_styles"  component={NavLink} to="/Home/revenue">
      ...
      <div className="today_Appointments"><span>Today's Appointments</span><span className="current_date">{current_date}</span></div>
            ...
            rowdata={[
                this.createData({type: <PhoneIphoneIcon className="react-icon-mob" />,name: "Abdul Khadher", gender: "Male", age: "35", time: "10.00 AM", service: "Consulting"}),
                this.createData({type: <img src={crowngold} />,name: "Md.Bilal", gender: "Male", age: "35", time: "10.30 AM", service: "Tooth Whitening"}),
                this.createData({type:<img src={Greenwalk} className="head-icon"/>,gender: "Male", number: "3", age: "35", time: "11.30 AM", service: "Root Canal"}),
 ...
 <div className="buttons_container">
        <div>
          <Button component={NavLink} to="/Home/availability" className="nurse_dash_bottom_buttons nurse_dash_bottom1">Availability Calendar</Button>
          <Button className="nurse_dash_bottom_buttons nurse_dash_bottom2" component={NavLink} to="/Home/mediaupload" >Media Upload</Button>
          <Button className="nurse_dash_bottom_buttons nurse_dash_bottom3" component={NavLink} to="/Home/advertise">Advertisement Booking</Button>
        </div>
        </div>
